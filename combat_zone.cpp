...
void CCombatZoneManager::AppendSkillCache(LPCHARACTER ch)
{
	...
	ch->SetQuestFlag("combat_zone_skills_cache.dwSkillLevel1",p.dwSkillLevel1);
	ch->SetQuestFlag("combat_zone_skills_cache.dwSkillLevel2",p.dwSkillLevel2);
	ch->SetQuestFlag("combat_zone_skills_cache.dwSkillLevel3",p.dwSkillLevel3);
	ch->SetQuestFlag("combat_zone_skills_cache.dwSkillLevel4",p.dwSkillLevel4);	
	ch->SetQuestFlag("combat_zone_skills_cache.dwSkillLevel5",p.dwSkillLevel5);
	ch->SetQuestFlag("combat_zone_skills_cache.dwSkillLevel6",p.dwSkillLevel6);
	db_clientdesc->Packet(&p, sizeof(p));
